	...
	render() {
      ...
      <div class="editor">
        <section>
          ...
          ${this._textInput("Tageskarten – Auswahl/Reihenfolge", (this._config.daily_items ?? []).join(", "), "pv, grid-import, grid-export, house, autarky, self-consumption, import-cost, export-revenue", (value) => this._with((config) => {
